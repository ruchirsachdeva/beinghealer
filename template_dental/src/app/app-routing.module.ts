...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./doctorregister/doctorregister.module').then((m) => m.DoctorregisterModule),
  },
  {
    path: 'video-call',
    loadChildren: () =>
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./doctorchangepassword/doctorchangepassword.module').then((m) => m.DoctorchangepasswordModule),
  },
];
