...
export class HomeComponent implements OnInit {
  ...
  sliderTestimonial = [
    {
      image:'assets/img/test-img1.jpg',
      title:'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam totam rem aperiam.',
      name:'Mary Wiley',
      designation:'Web Developer'
    },
    {

      image:'assets/img/test-img2.jpg',
      title:'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam totam rem aperiam.',
      name:'John Smith',
      designation:'Web Developer'
    },
    {
      ...
      image:'assets/img/test-img3.jpg',
      title:'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam totam rem aperiam.',
      name:'Clara Brady',
      designation:'Web Developer'
    },
    {
      ...
      image:'assets/img/test-img4.jpg',
      title:'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam totam rem aperiam.',
      name:'Farina Joes',
      designation:'Web Developer'
    }
...
slidesDoctor =[
  {
    ...
    doctor_name:'Karyen New',
    specialist_name:'BPT - Senior Physiotherapist',
    rating:'(23)',
    location:'Newyork, USA',
    availablity:'Available on Mon, 22 Sep',
    price:'$150 - $220'
  },
  {
    img:'assets/img/doctors/doctor-02.jpg',
    doctor_name:'Farrer Hackney',
    specialist_name:'BPT - Senior Physiotherapist',
    rating:'(12)',
  ...
  sliderContent = [
    {
      ...
      speciality_desc: "Lorem Ipsum is simply dummy text  the printing and typesetting industry."
    },
    {
