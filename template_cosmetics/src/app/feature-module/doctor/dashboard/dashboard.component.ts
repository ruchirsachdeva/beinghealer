...
export class DashboardComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService,public commonService: CommonService,private modalService: BsModalService) { }
  ...
  getPatients() {
    this.commonService.getPatientsAppointements()
    .subscribe(res=>{
      this.patients = res;
